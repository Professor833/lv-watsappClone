    ...
    return (
        <div className="chat">
            ...
            <div className="chat__footer">                           
                <InsertEmoticonIcon />
                <form >
                    <input value={input_msg} onChange={event => setinput_msg(event.target.value)} type="text" placeholder="Type a message" />
                    <button disabled={!input_msg} onClick ={sendMessage} type="submit" > Send Message</button>
                </form>
                <MicIcon />                
            </div>
        </div>
